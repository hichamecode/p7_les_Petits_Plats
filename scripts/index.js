...
const tagFinderForIngredients = new TagFinder(ingredients, '.ingredients_list', 'ingredient')
const tagFinderForAppliances = new TagFinder(appliances, '.appliances_list', 'appliance')
const tagFinderForUstensils = new TagFinder(ustensils, '.ustensils_list', 'ustensil')
...
function filterSearch(inputSelector, dataList, listSelector, elementClass) {
    ...
    inputField.addEventListener('input', () => {
        ...
        addFiltersToDom(listSelector, filteredData, elementClass)
    })
}
...
const filterCardIngredients = new FilterCard('.dropdown_menu_ingredients', '.filter_ingredients_card')
const filterCardAppliances = new FilterCard('.dropdown_menu_appliances', '.filter_appliances_card')
const filterCardUstensils = new FilterCard('.dropdown_menu_ustensils', '.filter_ustensils_card')
